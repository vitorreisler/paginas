  ...
  return (
    ...
    >
      ...
      <figure className="flex flex-col items-center">
        <Image
          src="/images/difusor-varetas-receita.webp"
          width={520}
          height={200}
          className="rounded-lg drop-shadow-md mb-4"
          alt="receita Difusor de Varetas Artesanal"
          loading="eager"
          fetchPriority="high"
          itemProp="image"
        />
        <figcaption className="text-sm text-gray-600 italic">
          Difusor de Varetas Artesanal
        </figcaption>
      </figure>
      ...
      >
        ...
        <ul className="py-4 px-3 list-disc" aria-label="Lista de ingredientes">
          ...
          <li itemProp="itemListElement">
            100ml de Essência de sua preferência
          </li>
          <li itemProp="itemListElement">50ml de Água mineral</li>
        </ul>
        <p>
