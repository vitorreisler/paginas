    ...
    return ( 
        <section className="flex flex-col items-center gap-5 mt-5">
            <h1 className="story-script-regular text-4xl text-center">Conheça minhas Redes Sociais</h1>
                ...
                <div className="flex gap-8">
                    <a className="bg-[#9a5833] border border-black p-4 rounded-xl text-center hover:drop-shadow-2xl hover:scale-105 duration-400" href="https://cursossilvia.vercel.app/rotas/cursos/cursoPedrasResina" target="_blank" rel="noopener noreferrer">
