...
const GarantiaIncont = () => {
  return (
    <section
      className="flex flex-wrap-reverse py-3 w-full bg-[#e3d7bf] justify-center lg:justify-between"
      aria-label="Seção de garantia"
    >
      <div className="my-auto w-full lg:w-1/2 text-center px-3">
        <header className="flex flex-col py-2">
          ...
          <hr />
          <p className="py-3 text-md dm-serif-text-regular">
